...
public class CustomerInformation
{
    ...
    //methods to add multiple items at once to the customer's list of purchased items
    ...
    public String toString() {
        return ("ID: " + custId + "\nIc: " + custIC + "\nCounter Paid: " + counterPaid + "\nQuantity: " + getItemQuantity() + displayPurchasedItems() + "Total : " + decimalFormat.format(totalPrice()) + "\n");
    }
}