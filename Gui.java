...
{//open class
    ...
    public Gui(LinkedList<CustomerInformation> customerList, Queue qCounter1, Queue qCounter2, Queue qCounter3,int totalCustomer, Stack<CustomerInformation> completedStack)
    {//open GUI
        ...
        // All Frame
        frame = new JFrame();
        frame.setTitle("HyperMarket Seasons");
    ...
    {//open actionPerformed
        ...
        {//open btnDisplay
            ...
            {
                JOptionPane.showMessageDialog(null , "Queue customer is empty.");
            }
